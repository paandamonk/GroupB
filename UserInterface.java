...
public class UserInterface extends JFrame implements ActionListener {
	...
	Staff Connor = new Staff("Connor","Colabella",0);
	...
	StaffAccount Connoracc = new StaffAccount(Connor.getFname(),"cman",Connor);

	private StaffAccount[] staffAcc = { Robacc, Kennyacc, Connoracc};
